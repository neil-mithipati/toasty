...
export function ToastCard({ toast }: ToastCardProps) {
  return (
    <motion.div
      ...
      transition={CARD_IN}
      className="flex h-60 w-full items-center justify-center overflow-hidden rounded-[36px] border-[7px] border-[#ffd84d] bg-white px-6 py-8 shadow-[0_10px_0_rgba(76,29,149,0.35),0_24px_44px_rgba(41,8,74,0.45)]"
    >
