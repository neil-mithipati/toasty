...
export function ToastCard({ toast }: ToastCardProps) {
  return (
    <motion.div
      ...
      transition={CARD_IN}
      className="flex max-h-[min(20rem,100%)] w-full items-center justify-center overflow-y-auto rounded-[36px] border-[7px] border-[#ffd84d] bg-white px-6 py-8 shadow-[0_8px_16px_rgba(20,8,35,0.45),0_24px_48px_rgba(20,8,35,0.3)]"
    >
